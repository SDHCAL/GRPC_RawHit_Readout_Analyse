...
class PadDevice : public DIFdrivenDevice
{
 public:
  ...
  std::pair<float,float> getPositionInPlanIn_mm(unsigned int I, unsigned int J, std::vector<RawCalorimeterHitPointer>& hits) const  {return std::make_pair(I*10.408f,J*10.408f);}
};
